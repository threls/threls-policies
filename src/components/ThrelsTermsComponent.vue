          ...
          <b-col
            ...
            <ol type="a">
              <li>Permission is granted to temporarily download one copy of the materials (information or software) on
                {{ entity }}'s website for personal, non-commercial transitory viewing only. This is the grant of a
                ...
                <ol type="i">
                  ...
                  <li>attempt to decompile or reverse engineer any software contained on {{ entity }}'s website;</li>
              ...
              terminated by {{ entity }} at any time. Upon terminating your viewing of these materials or upon the
      ...
      <b-container>
        <b-row>
          <b-col
            ...
            <h4>3. Disclaimer</h4>
            <ol type="a">
              <li>The materials on {{ entity }}'s website are provided on an 'as is' basis. {{ entity }} makes no
              warranties, expressed or implied, and hereby disclaims and negates all other warranties including,
              without limitation, implied warranties or conditions of merchantability, fitness for a particular
              purpose, or non-infringement of intellectual property or other violation of rights.
              </li>
              <li>Further, {{ entity }} does not warrant or make any representations concerning the accuracy, likely
      ...
      <b-container>
        <b-row>
          <b-col
            ...
            class="text-justify">
            <h4>4. Limitations</h4>
            <p>In no event shall {{ entity }} or its suppliers be liable for any damages (including, without
            limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or
            inability to use the materials on {{ entity }}'s website, even if {{ entity }} or a {{ entity }}
      ...
      <b-container>
        <b-row>
          <b-col
            ...
            <p>The materials appearing on {{ entity }}'s website could include technical, typographical, or
            photographic errors. {{ entity }} does not warrant that any of the materials on its website are accurate,
            complete or current. {{ entity }} may make changes to the materials contained on its website at any time
            without notice. However {{ entity }} does not make any commitment to update the materials.</p>
          </b-col>
        </b-row>
      </b-container>
    </section>
      ...
      <b-container>
        <b-row>
          <b-col
            ...
            class="text-justify">
            <h4>6. Links</h4>
            <p>{{ entity }} has not reviewed all of the sites linked to its website and is not responsible for the
            contents of any such linked site. The inclusion of any link does not imply endorsement by {{ entity }} of
      ...
      <b-container>
        <b-row>
          <b-col
            ...
            <p>{{ entity }} may revise these terms of service for its website at any time without notice. By using this
